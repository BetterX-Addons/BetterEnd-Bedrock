    ...
    if (data.block.hasTag(doorManager.doorTag)) {
        ...
        try {
            ...
            if (blockAbove.hasTag(doorManager.doorTag))
                doorManager.breakDoor(blockAbove.typeId, blockAbove, blockAbove.permutation.getState("betterend:upper_block_bit"));
        }
        catch { }
});
let int = 0;
